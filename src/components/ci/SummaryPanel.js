...
const SummaryPanel = ({ kpiData, filterParams }) => {
  ...
  useEffect(() => {
    ...
    // const mainTabContentH = $('.main-tabs-content .tab-content .tab-pane.active .__header').outerHeight();
    // $('.__content .scrollable').outerHeight(window.innerHeight - navbarH - mainTabItemH - mainTabContentH - 140);
    $(".__content .scrollable").outerHeight(
      $(".__content .scrollable .grid").outerHeight() + 140
    )
              ...
              <div className="d-flex justify-content-between align-items-center flex-wrap">
                <p className="info_box mb-0">
                  <strong>
                    ...
                    {displayProcessLine
                      ? displayProcessLine.processLineName
                      : "N/A"}
                  </strong>
                </p>
              </div>
