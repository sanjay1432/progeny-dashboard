...
const AddConsumptionThresholdDialog = ({
  showDialog,
  submitConfig,
  cancelConfig,
  processLines
  ...
  const handleSubmit = () => {
    ...
    delete formValue.kpiCategory
    const paramFormatted = _.cloneDeep(formValue)
    paramFormatted.startDate = moment(formValue.startDate).format()
    const param = {
      ...paramFormatted,
      bu,
  ...
  return (
    <>
      ...
      >
        <Modal.Header>
          <Modal.Title>Add Consumption Threshold</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddConsumptionThresholdDialog
